...
Revision ID: 27c2b83947de
Revises: d34b429440da
Create Date: 2020-05-10 20:15:45.774332
...
revision = '27c2b83947de'
down_revision = 'd34b429440da'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_constraint('survey_responses_ibfk_1', 'survey_responses', type_='foreignkey')
...
def downgrade():
    ...
    op.add_column('survey_responses', sa.Column('user_id', mysql.VARCHAR(length=50), nullable=True))
    ...
    op.create_foreign_key('survey_responses_ibfk_1', 'survey_responses', 'users', ['user_id'], ['user_id'])
    # ### end Alembic commands ###
